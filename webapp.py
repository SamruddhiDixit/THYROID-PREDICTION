...
def main():
    ...
    on_thyroxine= st.radio("On thyroxine?",options=['Yes','No'])
    query_on_thyroxine=st.radio("Query On thyroxine?",options=['Yes','No'])
    on_antithyroid_medication=st.radio("Antithyroid Medications?",options=['Yes','No'])
    sick=st.radio("feeling sick?",options=['Yes','No'])
    pregnant=st.radio("Pregnancy",options=['Yes','No'])
    thyroid_surgery=st.radio("Thyroid surgery History",options=['Yes','No'])
    I131_treatment=st.radio("On I131 Treatment",options=['Yes','No'])
    query_hypothyroid=st.radio("Query on Hypothyroid",options=['Yes','No'])
    query_hyperthyroid=st.radio("Query on Hyperthyroid",options=['Yes','No'])
    lithium=st.radio("Lithium Report",options=['Positive','Negative'])
    goitre=st.radio("Goitre",options=['Positive','Negative'])
    tumor=st.radio("Tumor",options=['Positive','Negative'])
    hypopituitary=st.radio("hypopituitary",options=['Positive','Negative'])
    psych=st.radio("psych",options=['Positive','Negative'])
